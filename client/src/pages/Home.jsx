...
import { Loader, Card, FormField } from '../components/exporter';
...
const Home = () => {
  ...
  //to make the post available in the community section
  useEffect(()=> {
...
import { Card, FormField, Loader } from '../components/exporter';
